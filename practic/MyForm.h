...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Лягичева Кристина";
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Location = System::Drawing::Point(12, 207);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(92, 72);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(92, 116);
			...
			this->label4->Location = System::Drawing::Point(14, 75);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(280, 72);
			...
			this->ClientSize = System::Drawing::Size(452, 230);
